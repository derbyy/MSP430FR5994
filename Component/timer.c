 ...
 *  Return      :   void
 **********************************************************************/
void comp_TimerA_Initialization(uint16_t u16BaseAddress, uint16_t u16CompValue)
{
    ...
    comp_Timer_A_SetCompValue(u16BaseAddress, TIMER_A_CAPTURECOMPARE_REGISTER_0, u16CompValue);
